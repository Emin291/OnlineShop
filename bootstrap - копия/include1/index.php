...
<?php  foreach ($result as  $value) :?>
      <div class="  my-2 mb-lg-0 col-12 col-md-6 col-lg-4 card" style="width: 18rem; height: 750px; ">
        <img style="height: 350px;" src="../img/<?php echo $value['img']?>">
          ...
          <p><?php echo cutText($value ['meta'])  ?></p>
         <div style="display: flex; align-items: flex-end; height: 100%">
          <a    href="single.php?id=<?php echo $value['id'] ?>" class=" btn btn-primary my-1 ">See details</a>
        </div></div>
      <?php endforeach ?>
      </div>
